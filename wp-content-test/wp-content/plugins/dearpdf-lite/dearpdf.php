...
if ( !class_exists( 'DearPDF' ) ) {
  ...
  class DearPDF {
     ...
     * @var string
     */
    public $settings_help_page = 'https://dearpdf.com/docs/settings/';
    /**
     * Plugin file.
     *
     * @since 1.0.0
    ...
    public function init_settings() {
      $this->post_tabs = array(
          'source'   => __( 'Source', 'dearpdf-lite' ),
          'general'  => __( 'General', 'dearpdf-lite' ),
          'flipbook' => __( 'Flipbook', 'dearpdf-lite' ),
          'advanced' => __( 'Advanced', 'dearpdf-lite' )
      );
      
      $this->post_shortcode_tabs = array(
          'embed'    => array(
              'title'   => __( 'Embed', 'dearpdf-lite' ),
              'content' => '<code>[dearpdf id="{id}" ][/dearpdf]</code><hr>
                  <a class="df-notice" href="https://dearpdf.com/docs/multiple-viewers-in-a-page/" target="_blank">Not best for multiple viewers in a page.</a>'
          ),
          'lightbox' => array(
              'title'   => __( 'LightBox(Popup)', 'dearpdf-lite' ),
              'content' => 'Button:<br><code>[dearpdf id="{id}" type="button"][/dearpdf]</code>'
          )
      );
      $this->defaults = array(
          'source'        => array(
              'std'            => "",
              'title'          => __( 'PDF File', 'dearpdf-lite' ),
              'desc'           => __( 'Choose a PDF File to use as source for the book.', 'dearpdf-lite' ),
              'placeholder'    => __( 'Select a PDF File', 'dearpdf-lite' ),
              'type'           => 'upload',
              'button-tooltip' => __( 'Select a PDF File', 'dearpdf-lite' ),
              'button-text'    => __( 'Select PDF', 'dearpdf-lite' ),
          ),
          'viewerType'    => array(
              'std'     => 'reader',
              'choices' => array(
                  'global'   => __( 'Default Setting', 'dearpdf-lite' ),
                  'reader'   => __( 'Vertical Reader', 'dearpdf-lite' ),
                  'flipbook' => __( 'Flipbook', 'dearpdf-lite' )
              ),
              'title'   => __( 'Viewer Type', 'dearpdf-lite' ),
              'desc'    => __( 'Choose the Viewer Type. Flipbook or normal viewer', 'dearpdf-lite' )
          ),
          'is3D'          => array(
              'std'       => 'true',
              'choices'   => array(
                  'global' => __( 'Default Setting', 'dearpdf-lite' ),
                  'true'   => __( 'WebGL 3D', 'dearpdf-lite' ),
                  'false'  => __( 'CSS 3D/2D', 'dearpdf-lite' )
              ),
              'title'     => __( 'Flipbook 3D or 2D', 'dearpdf-lite' ),
              'desc'      => __( 'Choose the mode of display. WebGL for realistic 3d', 'dearpdf-lite' ),
          ...
          'disableRange'  => array(
              ...
              'choices' => array(
                  'global' => __( 'Default Setting', 'dearpdf-lite' ),
                  'true'   => __( 'True', 'dearpdf-lite' ),
                  'false'  => __( 'False', 'dearpdf-lite' )
              ),
              'class'   => '',
              'title'   => __( 'Disable Partial Loading', 'dearpdf-lite' ),
              'desc'    => __( 'Partial loading, Chunk issues are discovered in some servers and browsers. Disabling range can fix that issue.', 'dearpdf-lite' )
          ),
          'readDirection' => array(
              'std'       => 'ltr',
              'choices'   => array(
                  'global' => __( 'Default Setting', 'dearpdf-lite' ),
                  'ltr'    => __( 'Left to Right', 'dearpdf-lite' ),
                  'rtl'    => __( 'Right to Left', 'dearpdf-lite' )
              ),
              'class'     => '',
              'title'     => __( 'Reading Direction', 'dearpdf-lite' ),
              'desc'      => __( 'Choose if the PDF follows Left to Right or Right to Left Reading Direction.', 'dearpdf-lite' ),
              'condition' => 'dearpdf_viewerType:is(flipbook)'
          )
      );
      $this->defaults['enableSound'] = array(
          ...
          'title'     => __( 'Auto Enable Sound', 'dearpdf-lite' ),
          'desc'      => __( 'Enable or disable Sound when flipbook starts', 'dearpdf-lite' ),
          'condition' => 'dearpdf_viewerType:is(flipbook)'
      );
      $this->defaults['backgroundColor'] = array(
          'std'         => "transparent",
          'title'       => __( 'Background Color', 'dearpdf-lite' ),
          'desc'        => __( 'Background color in hexadecimal format eg:<code>#FFF</code> or <code>#666666</code> or <code>transparent</code>', 'dearpdf-lite' ),
          'placeholder' => __( 'Example: #ffffff', 'dearpdf-lite' ),
          'type'        => 'text'
      );
      $this->defaults['backgroundImage'] = array(
          'std'            => "",
          'class'          => '',
          'title'          => __( 'Background Image', 'dearpdf-lite' ),
          'desc'           => __( 'Background image JPEG or PNG format:', 'dearpdf-lite' ),
          'placeholder'    => __( 'Select an image', 'dearpdf-lite' ),
          'type'           => 'upload',
          'button-tooltip' => __( 'Select Background Image', 'dearpdf-lite' ),
          'button-text'    => __( 'Select Image', 'dearpdf-lite' )
      );
      $this->defaults['height'] = array(
          'std'         => "auto",
          'title'       => __( 'Container Height', 'dearpdf-lite' ),
          'desc'        => __( 'Height of the flipbook container when in normal mode.<br> <code>500</code>for 500px <br> <code>auto</code>for autofit height <br> <code>100%</code>for 100% height (of parent element, else it will be 320px).', 'dearpdf-lite' ),
          'placeholder' => __( 'Example: 500', 'dearpdf-lite' ),
          'type'        => 'text'
      );
      $this->defaults['showDownloadControl'] = array(
          ...
          'title'   => __( 'Enable Download', 'dearpdf-lite' ),
          'desc'    => __( 'Enable PDF download', 'dearpdf-lite' )
      );
    }
    ...
    public function action_admin_menu() {
      ...
      //      $this->tools_menu_hook = add_submenu_page( 'edit.php?post_type=dearpdf', __( 'DearPDF Help and Tools', 'dearpdf-lite' ), __( 'Help and Tools', 'dearpdf-lite' ), 'manage_options',
    ...
    public function action_add_meta_boxes() {
      ...
      add_meta_box( 'dearpdf_post_meta_box_support_us', __( 'More Features in FULL VERSION!', 'dearpdf-lite' ), array( $this, 'create_meta_boxes_support_us' ), 'dearpdf', 'normal', 'high' );
      add_filter( 'postbox_classes_dearpdf_dearpdf_post_meta_box_support_us', array( $this, 'meta_box_add_class' ) );
      
      add_meta_box( 'dearpdf_post_meta_box', __( 'DEARPDF Settings', 'dearpdf-lite' ), array( $this, 'create_meta_boxes' ), 'dearpdf', 'normal', 'high' );
      add_filter( 'postbox_classes_dearpdf_dearpdf_post_meta_box', array( $this, 'meta_box_add_class' ) );
      
      add_meta_box( 'dearpdf_post_meta_box_shortcode', __( 'Shortcode', 'dearpdf-lite' ), array( $this, 'create_meta_boxes_shortcode' ), 'dearpdf', 'side', 'high' );
      add_filter( 'postbox_classes_dearpdf_dearpdf_post_meta_box_shortcode', array( $this, 'meta_box_add_class' ) );
      
      //      add_meta_box('dearpdf_post_meta_box_video', __('Video Tutorial', 'dearpdf-lite'), array($this, 'create_meta_boxes_video'), 'dearpdf', 'side', 'low');
      
    }
    
    function meta_box_add_class( $classes ) {
      array_push( $classes, 'df-metabox' );
    ...
    public function create_meta_boxes_support_us( $post ) {
      ...
      ?>
      <div class="df-notice lite-limits" style="padding:10px;">
    ...
    public function create_meta_boxes_shortcode( $post ) {
      ...
      if ( $current_screen->post_type == 'dearpdf' ) {
        if ( $current_screen->action == 'add' ) {
          ...
          <div class="df-tabs normal-tabs">
            <ul class="df-tabs-list">
              <?php
              //create tabs
              $active_set = false;
              foreach ( (array) $tabs as $id => $tab ) {
                ?>
                <li class="df-tab <?php echo( $active_set == false ? 'df-active' : '' ) ?>">
                  <a href="#df-tab-content-<?php echo $id ?>"><?php echo $tab['title'] ?></a></li>
                <?php $active_set = true;
              }
              ?>
            </ul>
            ...
            foreach ( (array) $tabs as $id => $tab ) {
              ?>
              <div id="df-tab-content-<?php echo $id ?>"
                      class="df-tab-content <?php echo( $active_set == false ? "df-active" : "" ) ?>">
      ...
      <div class="df-tabs">
        <ul class="df-tabs-list">
          ...
          foreach ( (array) $tabs as $id => $title ) {
            ?>
            <li class="df-update-hash df-tab <?php echo( !$active_set ? 'df-active' : '' ) ?>">
              <a href="#df-tab-content-<?php echo $id ?>"><?php echo $title ?></a></li>
            <?php $active_set = true;
          }
          ?>
        </ul>
        ...
        foreach ( (array) $tabs as $id => $title ) {
          ?>
          <div id="df-tab-content-<?php echo( $id ) ?>"
                  class="df-tab-content <?php echo( !$active_set ? "df-active" : "" ) ?>">
    ...
    public function notice_flipbook_tab() {
      ...
      <div class="df-notice" data-condition='dearpdf_viewerType:not(flipbook)'>Make sure <strong>General->Viewer Type</strong> is set to flipbook to use flipbook settings.</div>
    ...
    public function register_post() {
      $labels = array(
          'name'               => __( 'DearPDF Post', 'dearpdf-lite' ),
          'singular_name'      => __( 'DearPDF Post', 'dearpdf-lite' ),
          'menu_name'          => 'DearPDF',
          'name_admin_bar'     => __( 'DearPDF Post', 'dearpdf-lite' ),
          'add_new'            => __( 'Add Post', 'dearpdf-lite' ),
          'add_new_item'       => __( 'Add New DearPDF Post', 'dearpdf-lite' ),
          'new_item'           => __( 'New DearPDF Post', 'dearpdf-lite' ),
          'edit_item'          => __( 'Edit DearPDF Post', 'dearpdf-lite' ),
          'view_item'          => __( 'View DearPDF Post', 'dearpdf-lite' ),
          'all_items'          => __( 'All Post', 'dearpdf-lite' ),
          'search_items'       => __( 'Search DearPDF Posts', 'dearpdf-lite' ),
          'parent_item_colon'  => __( 'Parent DearPDF Posts:', 'dearpdf-lite' ),
          'not_found'          => __( 'No DearPDF Posts found.', 'dearpdf-lite' ),
          'not_found_in_trash' => __( 'No DearPDF Posts found in Trash.', 'dearpdf-lite' )
      );
      
      $args = array(
          'labels'              => $labels,
          'description'         => __( 'Description.', 'dearpdf-lite' ),
    ...
    public function shortcode_dearpdf( $raw_attr, $content = '', $multi = false ) {
      ...
      $html_attr['id'] = 'df_' . $id;
      $post_data['id'] = $id;
      $html_attr['data-option'] = 'df_option_' . $id;
    ...
    public function render_shortcode_html( $args ) {
      ...
      //default
      if ( $popup == "" ) {
        $html = '<div class="df-element' . esc_attr( $class ) . '" ' . $attrHTML . '></div>';
      } else {
        $html = '<div class="df-element' . esc_attr( $class ) . '" ' . $attrHTML . ' data-lightbox="button">' . esc_attr( $title ) . '</div>';
      }
    ...
    public function create_setting( $key, $setting = null, $value = null, $global_key = null, $global_value = '' ) {
      ...
      <div class="df-label"><label for="' . $slug . '_' . esc_attr( $key ) . '" >
			...
			</label><br><a class="df-help-link" target="_blank" href="' . $this->settings_help_page . '#' . esc_attr( strtolower( $key ) ) . '">More Info >> </a></div>';
    ...
    public function help_tools_page() {
      ...
      $tabs = array(
          'faqs'  => __( 'FAQs', 'dearpdf-lite' ),
          'tools' => __( 'Tools & Diagnostic', 'dearpdf-lite' )
      );
      ...
      <form id="df-settings" class="df-settings postbox">
        ...
        <div class="df-tabs">
          <ul class="df-tabs-list">
            ...
            foreach ( $tabs as $id => $title ) {
              ?>
              <li class="df-update-hash df-tab <?php echo( $active_set == false ? 'df-active' : '' ) ?>">
                <a href="#df-tab-content-<?php echo $id ?>"><?php echo $title ?></a></li>
              <?php $active_set = true;
            }
            ?>
